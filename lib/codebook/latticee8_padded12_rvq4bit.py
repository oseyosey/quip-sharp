...
from quip.lib.linear.autograd import AutogradQuipE84Bit, AutogradOrthoMult
...
class QuantizedE8P12RVQ4BLinear(nn.Module):
    ...
    def maybe_unpack_idxs(self, idxs):
        return idxs.reshape(idxs.shape[0], 2, idxs.shape[-1]//2).transpose(0, 1).contiguous()
    ...
    def forward(self,
        ...
        #* Custom Cuda *#
        x = AutogradQuipE84Bit.apply(x, self.codebook.grid_packed_abs, Qidxs, m, n, resid_scale)
        # W_decompressed = quiptools_cuda.decompress_packed_e8p(
